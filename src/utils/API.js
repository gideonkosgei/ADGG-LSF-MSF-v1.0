...
//Dashboard - Stats
// to cows
export const getTopCows = function (config, option,organisation_id, year) {
  const options = {
    url: `${config.url}${option}/${organisation_id}/${year}`,
    method: config.method,
    headers: config.headers
  }
  return new Promise((resolve, reject) => {
...
export const weightBatchModifyRevalidate = function (config, values, record_id, user_id, batch_type) {
  ...
  let { body_length, body_score, body_weight, heart_girth, weight_date, animal_tag_id, remove } = values;
...
export const animalBatchModifyRevalidate = function (config, values, record_id, user_id, batch_type) {
  ...
  date_of_birth = (typeof date_of_birth === 'undefined' || date_of_birth === '') ? date_of_birth : date_of_birth;
  ...
  remove = (typeof remove === 'undefined' || remove === '') ? 0 : remove;
  secondary_breed_id = (typeof secondary_breed_id === 'undefined' || secondary_breed_id === '') ? null : secondary_breed_id;
  ...
  Purchase_cost = (typeof Purchase_cost === 'undefined' || Purchase_cost === '') ? null : Purchase_cost;
  altitude = (typeof altitude === 'undefined' || altitude === '') ? null : altitude;
  animal_photo = (typeof animal_photo === 'undefined' || animal_photo === '') ? null : animal_photo;
  approx_age = (typeof approx_age === 'undefined' || approx_age === '') ? null : approx_age;
  dam_known_id = (typeof dam_known_id === 'undefined' || dam_known_id === '') ? null : dam_known_id;
  derived_birth_date = (typeof derived_birth_date === 'undefined' || derived_birth_date === '') ? null : derived_birth_date;
  deformaties_id = (typeof deformaties_id === 'undefined' || deformaties_id === '') ? null : deformaties_id;
  entry_date = (typeof entry_date === 'undefined' || entry_date === '') ? null : entry_date;
  farmer_name = (typeof farmer_name === 'undefined' || farmer_name === '') ? null : farmer_name;
  grps_accuracy = (typeof grps_accuracy === 'undefined' || grps_accuracy === '') ? null : grps_accuracy;
  hair_sample_id = (typeof hair_sample_id === 'undefined' || hair_sample_id === '') ? null : hair_sample_id;
  latitude = (typeof latitude === 'undefined' || latitude === '') ? null : latitude;
  longitute = (typeof longitute === 'undefined' || longitute === '') ? null : longitute;
  ...
  const body = {
    ...
    "color_id": color_id,
    "dam_known_id": dam_known_id,
    "dam_tag_id": dam_tag_id,
    "date_of_birth": date_of_birth,
    "deformaties_id": deformaties_id,
    "derived_birth_date": derived_birth_date,
    "entry_date": entry_date,
    "entry_type_id": entry_type_id,
    "farmer_name": farmer_name,
    "grps_accuracy": grps_accuracy,
    "hair_sample_id": hair_sample_id,
    "latitude": latitude,
    "longitute": longitute,
