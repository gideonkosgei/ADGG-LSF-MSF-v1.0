...
const Validate = props => {
  const {step,UploadedRecords} = props; 
  ...
  const uuid= sessionStorage.getItem('batch_upload_uuid');
  sessionStorage.removeItem('batch_upload_uuid');  
...
*/
  ...
  return (
    ...
    {sent ? (
      ...
      <Redirect to={`/batch-processing/workflow/${uuid}`}/>       
    ) : (
      <Fragment> 
