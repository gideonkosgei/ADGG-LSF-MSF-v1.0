...
function getStepContent(step) {
  switch (step) {
    case 0:
      return `Download the milk records templete from the downloads section. The templete should be used in its 
    ...
    case 4:
      return `This is the final step in the 3 part process. Any record that appears here has passed all the validation test and is fit for posting. Click post Button and you are done. To confirm the posting, you can check milking records`;
    default:
      return 'Unknown step';
  }
}
