...
const DetailsView = props => {
  ...
  useEffect(() => {     
    let mounted = true;
      ...
      })(endpoint_batch_posted_records,8,organization_id,user_id); 
      ...
      customBodyRender: (value, tableMeta, updateValue) => {        
        return (
          <Link
              ...
              to = {`/batch-process/animal/finalized/${tableMeta.rowData[0]}`}              
          >
            <OpenInNewIcon/>
          </Link>
  ...
  return (
    ...
    >
        <CardHeader title= "BATCH PROCESSES - Animal Reg"/>
        <Divider />
        <CardContent> 
