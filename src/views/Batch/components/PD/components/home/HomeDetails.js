...
function getStepContent(step) {
  switch (step) {
    case 0:
      return `Download the PD template from the downloads section. The template should be used in its 
      ...
      `;
    case 1:
      return 'Populate the template with the PD records. Avoid as much as posssible the use of special characters and symbols';
    case 2:
    ...
    case 4:
      return `This is the final step in the 3 part process. Any record that appears here has passed all the validation test and is fit for posting. Click post Button and you are done. To confirm the posting, you can check PD records`;
    default:
      return 'Unknown step';
  }
}
