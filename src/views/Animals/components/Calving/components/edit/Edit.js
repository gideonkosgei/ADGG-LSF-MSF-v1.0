...
import {Card,CardContent,CardHeader,LinearProgress,Grid,Divider,TextField,colors,Button,CardActions,Box,Switch,Typography,Tooltip} from '@material-ui/core';
  ...
  return (
    ...
    >  
     <Typography
      ...
      variant="h3"
      >
       {`CALVING RECORD - ${animal_name}(${animal_tag}) `}
      </Typography>
      <br/>         
      <Header />
      <br/>
