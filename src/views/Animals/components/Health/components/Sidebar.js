    ...
    <Card {...rest} className={clsx(classes.root, className)}  >
      ...
      <Tooltip  title="Home">              
          <IconButton aria-label="home" size="small" >
            <Link component = {RouterLink} to={`/management/health/view/${animal_id}`}>
              <HomeIcon /> 
            </Link>
          </IconButton> 
        </Tooltip>
        ...
        <Tooltip  title="Add New">              
          <IconButton aria-label="add" size="small" >
            <Link component = {RouterLink} to={`/management/health/add/${animal_id}`}>
              <AddIcon /> 
            </Link>
          </IconButton> 
        </Tooltip>
        <Tooltip  title="graph">              
          <IconButton aria-label="graph" size="small" >          
            <Link component = {RouterLink} to={`/management/health/charts/${animal_id}`}>
              <BarChartIcon /> 
            </Link>
          </IconButton> 
        </Tooltip>      
